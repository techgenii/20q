...
def generate_speech(text, voice_id=None, model_id="eleven_turbo_v2", context="quick_response"):
    """
...
def generate_speech_base64(text, voice_id=None, model_id="eleven_turbo_v2", context="quick_response"):
    """
...
def generate_game_message_audio(message_type, voice_id=None, **kwargs):
    ...
    context = "game_host" if message_type == "welcome" or message_type == "welcome_with_difficulty" else "quick_response"
...
try:
    ...
    async def generate_speech_async(text, voice_id=None, model_id="eleven_turbo_v2", context="quick_response"):
